...
InventoryList inventoryDataList = InventoryList.fromList([
  ...
  InventoryItem(name: 'Eggs', quantity: 12, unit: 'dozen'),
  InventoryItem(name: 'Bread', quantity: 2, unit: 'loaves'),
  InventoryItem(name: 'Coffee', quantity: 250, unit: 'g'),
  InventoryItem(name: 'Sugar', quantity: 1, unit: 'kg'),
  InventoryItem(name: 'Salt', quantity: 1, unit: 'tsp'),
